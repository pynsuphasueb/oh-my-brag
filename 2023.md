...
# What I Learned
- learning kata code and TDD @atbee
- Data Pipelines with Airflow by @zkan
- Airflow notifications @atbee
- 13 Airflow Tricks
...
- Basic dbt and super basic SQL by @zkan
- dbt project evaluator @zkan

- Cloud 101 using AWS and knowledge of network security @atbee
- Terraform 101 @atbee
- Basic poetry
...
# Outside of work
- Chiangmai Hackatrain with @backwizard
- Agile Tour Bangkok
