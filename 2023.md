...
3. Create my 1st Medium blog or Data Engineer Cafe เนื่องจาก ยังไม่เคยเขียน blog ที่ไหนมาก่อน จึงอยากเริ่มที่จะเขียน blog สำหรับสิ่งที่ตัวเราเองต้องการจะแชร์ให้คนอื่น รวมถึงสิ่งที่เรา research มาเพื่อเป็นคลังความรู้ให้ตัวเองอ่านอีกด้วย
...
5. สร้าง API ด้วย GO เพื่อช่วยในการสร้าง ingestion service ต่างๆ และ ช่วยในหาร prepare hackatrain
...
!!! ตรงนี้เดี๋ยวจัดกลุ่ม แล้วทำการกไหนดว่า week ไหนเดือนไหนเรียนรู้เรื่องอะไร

!!! จัดลำกับความสำคัญด้วย

!!! อาจจะเป็นการเรียนรู้ทุกวันดีกว่า เดี๋ยวขอคิดแป๊ป
